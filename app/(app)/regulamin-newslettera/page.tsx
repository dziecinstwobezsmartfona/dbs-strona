        ...
        <main className="bg-(--main-accent) min-h-screen flex flex-col items-center justify-top pt-45">
            ...
            <section className="flex flex-col bg-white rounded-3xl items-center justify-center w-3/4 mx-auto mb-16">
                <div className="text-left w-full p-8 lg:p-16">
                    <h1 className="text-2xl xl:text-3xl font-title pb-6">Regulamin newslettera Fundacji "Dzieciństwo Bez Smartfona"</h1>
                    <p className="text-sm xl:text-lg font-sans pb-6">
                        Regulamin newslettera Fundacji "Dzieciństwo Bez Smartfona", zwany dalej „Regulaminem" określa prawa i obowiązki stron usługi świadczonej elektronicznie za pośrednictwem serwisu pod adresem https://dziecinstwobezsmartfona.pl.
                    </p>
                    ...
                    <ul className="text-sm xl:text-lg font-sans pb-6 list-disc list-inside">
                        <li><strong>Fundacja</strong> - Fundacja "Dzieciństwo Bez Smartfona" z siedzibą w Warszawie, Aleje Jerozolimskie 109/70, 02-011 Warszawa</li>
                        ...
                        <li><strong>Newsletter</strong> - wiadomość przekazywana przez Fundację pocztą elektroniczną, zawierająca informacje o działalności Fundacji, realizowanych, organizowanych i współorganizowanych przez nią akcjach, kampaniach społecznych i wydarzeniach, oraz o funkcjonalnościach Serwisu, a także zawierając informacje marketingowe;</li>
                        <li><strong>Umowa Newslettera</strong> - zobowiązanie, którego przedmiotem jest nieodpłatne świadczenie przez Fundację na rzecz Użytkownika, usługi polegającej na przesyłaniu newslettera na adres e-mailowy wskazany przez Użytkownika;</li>
                    ...
                    <ul className="text-sm xl:text-lg font-sans pb-6 list-disc list-inside">
                        ...
                        <li>kliknięcie w Link Aktywacyjny przesłany przez Fundację, na adres wprowadzony w sposób wskazany w lit. b) powyżej.</li>
                    </ul>
                    <p className="text-sm xl:text-lg font-sans pb-6">
