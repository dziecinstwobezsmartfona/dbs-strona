    ...
    return (
        <main className="bg-(--main-accent) min-h-screen flex flex-col items-center justify-top pt-45">
            <header className="flex flex-col w-3/4 lg:w-1/2 mx-auto items-center justify-center text-center">
                ...
                <p className="text-5xl/16 md:text-6xl/20 xl:text-8xl/32 font-title mb-12">Zmiana jest zaraźliwa</p>
                <p className="text-lg md:text-base xl:text-xl mb-8">„Dzieciństwo Bez Smartfona" to nie kampania – to <b>zmiana kulturowa</b>, która zyskuje popularność na całym świecie.</p>
                <p className="text-lg md:text-base xl:text-xl mb-8">Rodziny stawiają opór, co zmienia charakter rozmów, a <b>presja</b>, by dać dzieciom smartfona, „bo wszyscy inni go mają", <b>w końcu zaczyna ustępować</b>.</p>
                <p className="text-lg md:text-base xl:text-xl mb-8">Dzięki temu, dzieciństwo zaczyna się zmieniać, a <b>każdy dodatkowy rok dziecka bez smartfona to zwycięstwo</b>. Każdy niekupiony smartfon, każda usunięta aplikacja, każda szczera rozmowa – to wszystko jest ważne.</p>
                <p className="text-lg md:text-base xl:text-xl mb-12">Tak właśnie dokonuje się zmiana: <b>krok po kroku, rozmowa po rozmowie, rodzina po rodzinie</b>.</p>
            </header>
            <section className="flex flex-col bg-white rounded-3xl items-center justify-center w-3/4 mx-auto mb-16">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center w-full">
                    <div className="text-left order-2 lg:order-2 w-full p-8 lg:p-16">
                        ...
                        <p className="text-sm xl:text-lg font-sans">Jest to problem istotny i dostrzegany już na świecie.</p>
                    </div>
